...
if (isset($_POST['register'])) {
    ...
    $check = "select * from proudcts where email='{$email}'";
        ...
        if (mysqli_num_rows($res1) > 0) {
            ...
            if ($res1) {
                ...
                if (mysqli_num_rows($res1) > 0) {
                    ...
                    echo "<a href='javascript:self.history.back()'></a>
                          <p> password is wrong</p>                           ";
                } else {
                    if ($pass === $cpass) {

                        $sql = "INSERT INTO proudcts (username, email, password) VALUES ('$name', '$email', '$passwd')";
